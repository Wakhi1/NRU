// Account & security — read-only here by design. SPTS holds no local password and no local
// authenticator-app/email-OTP state for anyone; "there should be one database that records if a
// user has enrolled in an authenticator app — that is the HRIS." Enrollment, disabling, backup
// codes, and password changes all happen in the HRIS itself and simply take effect here — this
// page just shows what's currently true there.
(async () => {
