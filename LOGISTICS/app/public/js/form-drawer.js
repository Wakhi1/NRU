// Right-side sliding drawer for view/create/edit interactions — ported from SPTS/the HRIS's own
// form-drawer.js so every app in the ecosystem shares the same interaction pattern.
//
// FormDrawer.open({
//   title, sub,
