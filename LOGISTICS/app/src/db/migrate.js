...
// Strips full-line `--` comments BEFORE splitting on `;` — a section-header comment glued to the
// front of a CREATE TABLE statement would otherwise cause the whole statement to be silently
// dropped by a naive filter (a real bug hit and fixed while building SPTS's own migrate.js).
